...
export default function ServiceCenter() {
  return (
    <section className='h-fit flex items-center justify-center mt-10 bg-orange-500 md:p-20 p-5' style={{backgroundImage: 'url("https://i.ibb.co/5YLswnN/bg-fix.png")'}}>
      ...
      <div className='relative flex items-center h-full w-full md:flex-row flex-col gap-3 md:gap-0 bg-white rounded-xl md:p-20 p-10'>
        ...
        {/* title */}
        <div className='lg:w-1/2 w-fit flex flex-col text-center gap-3'>
