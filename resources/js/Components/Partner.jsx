  ...
  return (
    <section className='h-fit my-10 px-5'>
      ...
      <div className='flex flex-col md:flex-row lg:justify-between'>
        {/* company logo */}
        <div className='grid grid-cols-4 w-100 lg:w-1/2 bg-orange-500 gap-3 items-center border border-orange-100 rounded-lg p-5 m-3 md:m-0 order-2 md:order-1'>
        ...
        {/* title and more info */}
        <div className='flex flex-col md:gap-10 gap-5 my-5 md:my-0 items-center justify-center mx-auto text-center order-1 md:order-2'>
